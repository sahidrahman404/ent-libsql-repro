...
func (tq *TodoQuery) FirstID(ctx context.Context) (id pksuid.ID, err error) {
	var ids []pksuid.ID
...
func (tq *TodoQuery) FirstIDX(ctx context.Context) pksuid.ID {
...
func (tq *TodoQuery) OnlyID(ctx context.Context) (id pksuid.ID, err error) {
	var ids []pksuid.ID
...
func (tq *TodoQuery) OnlyIDX(ctx context.Context) pksuid.ID {
...
func (tq *TodoQuery) IDs(ctx context.Context) (ids []pksuid.ID, err error) {
...
func (tq *TodoQuery) IDsX(ctx context.Context) []pksuid.ID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tq *TodoQuery) loadChildren(ctx context.Context, query *TodoQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *Todo)) error {
	...
	nodeids := make(map[pksuid.ID]*Todo)
	for i := range nodes {
